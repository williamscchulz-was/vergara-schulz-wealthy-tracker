...
const IMP_CATS = [
  ...
  ['transporte', ['uber','99','indrive','cabify','latam','localiza','movida','unidas','ipiranga','shell','petrobras','texaco','veloe','conectcar','smiles','clickbus','buser','metro','cptm'], ['posto','combust','estacion','pedagi','gasolin','rodoviar','uber'], ['99app','rek park','sem parar','auto re','bilhete unico','azul linhas','gol linhas','voe gol','tam linhas']],
  ...
  ['compras', ['amazon','shopee','mercadolivre','magalu','magazine','americanas','submarino','casasbahia','pontofrio','kabum','fastshop','samsung','nike','adidas','decathlon','centauro','netshoes','dafiti','riachuelo','renner','marisa','pernambucanas','hering','zara','cea','shein','aliexpress','havan','leroy','telhanorte','tokstok','mobly','etna','petz','cobasi','petlove','kalunga'], ['marketplace','amazon'], ['mercado livre','casas bahia','ponto frio','fast shop','tok stok','leroy merlin','madeira madeira','ri happy','pb kids']],
